...
export const generaPdf_reporte_fa_cap = async function (req, res) {
  //crear un documento
  ...
  doc.setDocumentHeader({}, () => {
    ...
    .fillColor("#000")
    .fontSize(10)
    .text("Reporte facilitadores y capacitacitaciones ", 350, 30,{width: 255}, { aling: "left" });
    doc
      .fillColor("#000")
      .fontSize(10)
      .text("Fecha de reporte:", 350, 45)
      .text(fecha.toDateString(), 380, 45, { align: "right" });
    doc
  ...
  doc.moveDown();
    ...
    const lista = await await models.informe_facilitador_capacitacion.findAll({
      attributes: [],
      where:
      { 
    ...
    doc.addTable(
      ...
      [
          ...
          {key: 'cap', label: 'Capacitación', align: 'left'},
          {key: 'fIni', label: 'Fecha inicio', align: 'left'},
          {key: 'fFin', label: 'Fecha fin', align: 'left'}
      ],
      lista, {
          border: null,
          width: "fill_body",
